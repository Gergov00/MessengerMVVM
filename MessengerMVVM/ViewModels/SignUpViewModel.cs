...
namespace MessengerMVVM.ViewModels
{
    public class SignUpViewModel : BindableBase
    {
        ...
        public SignUpViewModel(INavigationService navigationService, SignUpModel model)
        {
            _model = model;
        ...
        private void ExecuteGoToLogInPage()
        {
            _navigationService.NavigateToAsync<MainWindow>();
        }
